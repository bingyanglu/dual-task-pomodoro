      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Explanation Section - Only show in dual task mode */}
            {settings.dualTaskMode && (
              <Card className="border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 dark:border-blue-800 dark:from-blue-900/20 dark:to-indigo-900/20">
                <CardHeader
